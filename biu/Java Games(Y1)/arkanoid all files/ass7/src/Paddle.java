...
public class Paddle implements Sprite, Collidable {
    ...
    public void Shoot(){
    	if(this.timealapssed==10){
    		Point p=new Point(this.rect.getUpperLeft().getX()+this.rect.getWidth()/2,
        			this.rect.getUpperLeft().getY());
        	Ball bullet=new Ball(p,5,Color.WHITE);
        	bullet.setVelocity(new Velocity(0,-560));
