...
'''
goal : to transfer data from an some distrabution to data in the form of line,parbula,spiral

how: model 1 will generate data --> generator and will get feed back if his data is good (from model2)
     model 2 will be a regular classifier will be trained on generate_data examples
