...
public class GameLevel implements Animation {
    ...
    public void initialize() {
        ...
        BallRemover listner2 = new BallRemover(this, this.ballRemaine);
    ...
    public void doOneFrame(DrawSurface d, double dt) {
        ...
        if (this.ballRemaine.getValue() == 0) {
            this.livesInd.decrease(1);
    ...
    public void playOneTurn() {
        ...
        for (int i = 0; i < data.numberOfBalls(); i++) {
            Ball ball = new Ball(400, 565, 6, java.awt.Color.white);
            ball.setVelocity(data.initialBallVelocities().get(i));
            ball.addToGame(this);
        }
        this.ballRemaine.increase(data.numberOfBalls());
